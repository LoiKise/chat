    ...
    return (
       <>
            ...
            <div className="header__button">
                <a href="#" className="button button--oranged button--animated">tra cứu <img className="button--img" src="./img/icon/Asset 15.png" alt=""></a>
                <a href="#" className="button button--transparent button--animated"><span className="underline">dịch vụ <img className="button--img" src="./img/icon/Asset 15.png" alt=""></span></a>
            </div>
       </>
    )
}
