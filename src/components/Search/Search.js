                ...
                <div className="tabs_content">
                    <Panel value={index} index={0}>
                        <div className="tabs__content__code">
                            ...
                            <button><SearchSharpIcon /> Tra cứu vận đơn</button>
                        </div>
                    </Panel>
                    <Panel value={index} index={1}>
                        <div className="tab_content_move">
                            ...
                            <div className="row">
                                <div className="col-md-4">
                                    <div className="ordernow-form__userinfor-item">
                                        <input type="text" name="" id="" className="ordernow-form__username" placeholder="Tỉnh/Thành Phố" />
                                        <img src="./assets/img/icon/tomato_down_arrow.png" className="ordernow-form__icon" alt="" />
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="ordernow-form__userinfor-item">
                                        <input type="text" name="" id="" className="ordernow-form__userphone" placeholder="Huyện/Quận" />
                                        <img src="./assets/img/icon/tomato_down_arrow.png" className="ordernow-form__icon" alt="" />
                                    </div>
                                </div>
                                <div className="col-md-4">
                                    <div className="ordernow-form__userinfor-item">
                                        <input type="text" name="" id="" className="ordernow-form__useremail" placeholder="Xã/Thị Xã" />
                                        <img src="./assets/img/icon/tomato_down_arrow.png" className="ordernow-form__icon" alt="" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-md-4">
                                    <div className="ordernow-form__userinfor-item">
                                        <input type="text" name="" id="" className="ordernow-form__username" placeholder="Kg" />
                                        <img src="./assets/img/icon/tomato_down_arrow.png" className="ordernow-form__icon" alt="" />
                                    </div>
                                </div>
                            ...
                            <button className="btn_tab_search"><SearchSharpIcon /> Tra cứu vận chuyển</button>
                        </div>
                    </Panel>
                    <Panel value={index} index={2}>
                        <div className="tab_content_Office  d-flex">
                            ...
                            <button className="btn_tab_search"><SearchSharpIcon /> Tra cứu</button>
                        </div>
                    </Panel>
                </div>
            </div>
