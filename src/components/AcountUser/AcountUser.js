          ...
          <div className="col col-md-4 col-12 personal--left text-center">
            ...
            <div className="personal--infor">
              ...
              {!changePass && !statusSocial && (
                <div>
                  <p className="infor--password p-2">
                    Mật khẩu:{" "}
                    <span className="font-weight-bold">************</span>
                  </p>
                  <a className="infor--changepass" onClick={toogleChangePass}>
                    Đổi mật khẩu
                  </a>
                </div>
              )}
              {changePass && (
                <div>
                  ...
                  <br />
                  <a className="infor--changepass" onClick={changePassword}>
